...
class UploadPostController: UIViewController {
    ...
    private lazy var cationTextView: InputTextView = {
    ...
    @objc func didTapDone() {
        ...
        guard let user = currenUser else { return }
    ...
    func configureUI() {
        ...
        cationTextView.anchor(top: photoImageView.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor,
                              paddingTop: 16, paddingLeft: 12, paddingRight: 12, height: 64)
        
        view.addSubview(characterCountLabel)
        characterCountLabel.anchor(bottom: cationTextView.bottomAnchor, right: view.rightAnchor,
